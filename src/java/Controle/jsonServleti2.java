...
@WebServlet(name = "jsonServleti2", urlPatterns = {"/jsonServleti2"})
public class jsonServleti2 extends HttpServlet {

    private static final long serialVersionUID = 1L;
    DaoRelatorio acessohibernaterelatorio;

    public jsonServleti2() {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Pedido> ListaPedidosFechados;
        ListaPedidosFechados = (List<Pedido>) acessohibernaterelatorio.PedidosFechados(Pedido.class);
