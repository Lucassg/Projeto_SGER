...
public class test2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int pedido = 0; pedido < ListaPedidos.size(); pedido++) {
            ...
            String destino = ListaPedidos.get(pedido).getCliente().enderecoToString();
            ...
            ParEnderecos.setDistancia(distanceMatrix.rows[0].elements[0].duration.inSeconds);
...
//        }
        ...
        for (int pedido1 = 0; pedido1 < ListaPedidos.size() - 1; pedido1++) {
            ...
            for (int pedido2 = pedido1 + 1; pedido2 < ListaPedidos.size(); pedido2++) {
                 ...
                 */
                String destino = ListaPedidos.get(pedido2).getCliente().enderecoToString();
