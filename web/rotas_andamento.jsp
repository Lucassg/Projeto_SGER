    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="table-responsive">
                <center><b><h3>Rotas em Andamento</h2></b></center>
                <br>
                    ...
                    <tbody>
                        ...
                        <c:forEach items="${ListaRotas}" var="Rota">
                            <tr>
                                ...
                                <td><a href="Controle?classe=ControleLogicoRota&acao=listar_pedidos_rota&rota=${Rota.id}"><input type="image" src="img/search.png" name="visualizar"></a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>        
